...
fish_filtered_1 <- fishraw %>% 
  dplyr::select(c(Record.number, Individual.ID, Predator, Predator.common.name, 
                  Predator..taxon, 
           Predator.lifestage, Type.of.feeding.interaction, Predator.length, Predator.length.unit, Predator.dimension.measured, Predator.fork.length, Predator.total.length,
